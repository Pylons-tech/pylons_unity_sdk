...
namespace PylonsIpc
{
    public abstract class IpcTarget
    {
        ...
        public virtual string GenerateDevProcessArguments(bool hosted) => "";

        public IpcTarget (string _androidActivityName, string _androidPackageName, string _androidServiceName, int _devProcessComPort, string _devProcessName, string _devProcessPath)
        {
